...
public class SubmitApplicationNegative extends BaseTest {
    ...
    {
        setTestCase("Submit ILab application Negative test", "12");
        ...
        setTestStep("Select the first Job Opening", "Navigate to a page with South African Job opennings");
        ...
        TextIs("txtErrorMessage","XPATH", "There are errors in your forms.");
    }
